...
std::default_random_engine generatorMultiMute (0);  // minstd_rand0 is a standard linear_congruential_engine
...
vector<bool> MultiMute::formatString(int maxSize, vector<char> * mutationsChars){
	...
	shuffle(insertions->begin(), insertions->end(), generatorMultiMute);
	int j = 0;
	int i = 0;
